    ...
    tabItems(
      tabItem(tabName = "intro", 
              fluidRow(h2("Background on Rails"), 
                      "If Warren Buffet were stuck in a deserted island and could only have
              ...
              fluidRow(h2("Economic Relationship"), 
                       "Consistent with Buffet's claims, the plot below shows a clear relationship between
                       rail carloads and ISM Manufacturing Index, which is one of the most important metrics
                       for the US economy."
                       ), 
              fluidRow(box(plotOutput('CarloadISM'), width = 12)),
      ...
      tabItem(tabName = "aboutme", fluidRow("hello")
              )
      )
    )
  )
